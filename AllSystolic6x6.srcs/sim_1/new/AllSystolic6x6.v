...
input wire clk, 
    ...
    wire signed [WIDTH-1:0] y00_in, y01_in, y02_in, y03_in, y04_in, y05_in,
           ...
           // *** Valid registers ***
    wire in_valid_reg0, in_valid_reg1, in_valid_reg2, in_valid_reg3, 
         in_valid_reg4, in_valid_reg5, in_valid_reg6, in_valid_reg7, 
         in_valid_reg8, in_valid_reg9, in_valid_reg10, in_valid_reg11, in_valid_reg12,
         
         a05_out,a15_out,a25_out,a35_out, a45_out, a55_out, // Outputs of systolic array
wire signed [WIDTH-1:0]                                                                                                                                        reg50y_0out, 
wire signed [WIDTH-1:0]                                                                                                                                        reg50y_1out,                        reg51y_0out,                        /*y2*/
wire signed [WIDTH-1:0]                                                                                                                                        reg50y_2out,                        reg51y_1out,                        reg52y_0out,                        /*y3*/
wire signed [WIDTH-1:0]                                                                                                                                        reg50y_3out,                        reg51y_2out,                        reg52y_1out,                        reg53y_0out,                        /*y4*/
wire signed [WIDTH-1:0]                                                                                                                                        reg50y_4out,                        reg51y_3out,                        reg52y_2out,                        reg53y_1out,                        reg54y_0out,                          /*y5*/
wire signed [WIDTH-1:0]                                                                                                                                        reg50y_5out,                        reg51y_4out,                        reg52y_3out,                        reg53y_2out,                        reg54y_1out,                          reg55y_0out,                          /*y6*/
